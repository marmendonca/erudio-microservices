...
namespace GeekShopping.Web.Integrations
{
    public static class HttpClientExtensions
    {
        ...
        public static async Task<T> ReadContentAs<T>(this HttpResponseMessage response)
        {
            ...
            var dataResponse = JsonSerializer.Deserialize<T>(dataAsString, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
